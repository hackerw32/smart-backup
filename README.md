...
Στο `%APPDATA%\SmartBackup\index\` κρατείται ένα μικρό index (SQLite) με ό,τι έχει ήδη
συγχρονιστεί, ώστε η εκκίνηση να είναι **γρήγορη** χωρίς πλήρη σάρωση του backup κάθε φορά.
